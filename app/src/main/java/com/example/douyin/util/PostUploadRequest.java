...
public class PostUploadRequest extends Request<JSONObject> {
    ...
    public PostUploadRequest(String url, Map<String, String[]> fileMap,Map<String, String> mapText, Response.Listener<JSONObject> mListener, Response.ErrorListener listener) {
